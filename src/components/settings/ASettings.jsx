          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="md:w-2/3 space-y-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue="Dr. Alexander Wright"
              ...
              <div>
                ...
                <input
                  type="email"
                  defaultValue="alexander.wright@edu-inst.com"
                  className="w-full mt-2 p-3 bg-gray-200 rounded-md cursor-not-allowed"
                  readOnly
                />
              </div>
              ...
              <div className="pt-4 flex gap-3">
                ...
                {/* <button className="bg-green-600 text-white px-6 py-2 rounded-md opacity-50 cursor-not-allowed">
                  Save
                </button>

                <button className="bg-gray-400 text-white px-6 py-2 rounded-md opacity-50 cursor-not-allowed">
                  Cancel
                </button> */}
              </div>
