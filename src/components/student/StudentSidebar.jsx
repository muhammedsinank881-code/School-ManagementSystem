...
const StudentSidebar = () => {
  const SidebarIcons = [
    { id: 1, name: "Dashboard", icon: <BiHomeAlt2 />, path: "/layout" },
    { id: 2, name: "Teachers", icon: <IoMdContacts />, path: "/teachers" },
    { id: 3, name: "Timetable", icon: <MdClass />, path: "/timetable" },
      ...
      <div className=" ">
        ...
        <div className="space-y-1">
          {SidebarIcons.map((items) => (
            ...
            className={({ isActive }) =>    isActive ? "flex items-center gap-3 p-2 w-full hover:bg-blue-600 rounded-md bg-blue-600" : "flex items-center gap-3 p-2 w-full hover:bg-blue-600 rounded-md"}
            >
              {items.icon}
